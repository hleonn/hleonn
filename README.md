...
- 🟡 I'm "FullStack Eng". Working on MERN projects at MealKits Food-Startup  using several technologies, like MongoDB, Express, React, NodeJS, TypeScript, NextJS, Jest, Formik, StoryBook, Figma, Github, Visual Studio Code, Webstorm, Github, Postman
- 🟡 My last Job was at "Warp", a digital bank-Startup" like "FullStack Eng"
- ⚪️ I like technological research and development, focused on Biomechanics, Robotics, Mechatronics, Energy, Sustainability, Data Analysis, and Software Eng.
- 🔵 PhD in Science (Renewable Energy & Climate Change)...CINVESTAV-MEX
- 🟢 Research resume in researchgate (9 publications, +5000 reads & 13 citations)
